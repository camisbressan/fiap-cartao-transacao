...
public class GeneratePdfReport {
	...
	public static ByteArrayInputStream extratoTodasTransacoes(List<TransacaoDTO> transacoes) {
		...
		try {
			...
			paragraph.add(new Phrase("Extrato das transações ", title));
	...
	public static ByteArrayInputStream extratoTransacoesPorAluno(List<TransacaoDTO> transacoes, AlunoDTO aluno) {
		...
		try {
			...
			// Título do extrato
			Paragraph paragraph = new Paragraph();
			paragraph.add(new Phrase("EXTRATO: " + aluno.getNome(), title));
			paragraph.setAlignment(Element.ALIGN_CENTER);
			paragraph.add(new Paragraph(" "));
			document.add(paragraph);
